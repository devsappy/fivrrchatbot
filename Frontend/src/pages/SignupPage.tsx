                ...
                <div className="hidden lg:flex flex-col justify-between w-1/2 relative rounded-[32px] overflow-hidden p-12 text-white shadow-2xl bg-black min-h-[70vh]">
                    ...
                    <div className="relative z-20 mb-4 px-2">
                        ...
                        <div className="flex gap-2">
                            <div className="w-8 h-1 bg-white hover:bg-white/80 cursor-pointer rounded-full transition-colors"></div>
                            <div className="w-8 h-1 bg-white/30 hover:bg-white/50 cursor-pointer rounded-full transition-colors"></div>
                            <div className="w-8 h-1 bg-white/30 cursor-pointer rounded-full transition-colors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-10 lg:px-12 xl:px-24 text-gray-900 py-12 lg:py-0">
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center pt-1 pb-3">
                                ...
                                <label htmlFor="terms" className="ml-2 text-sm text-gray-600 font-medium cursor-pointer select-none">
                                    I agree to the <a href="#" className="underline hover:text-[#5227FF]">Terms & Conditions</a>
                                </label>
                            </div>
                        ...
                        <div className="flex items-center my-8">
                            ...
                            <span className="px-5 text-sm font-semibold text-gray-400">Or register with</span>
                            <div className="flex-grow border-t border-gray-200"></div>
                        </div>
