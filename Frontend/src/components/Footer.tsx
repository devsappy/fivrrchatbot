        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.instagram.com/chatterify.in/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-white/20 transition-all duration-300" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/share/1AtzkurRFK/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-white/20 transition-all duration-300" aria-label="Facebook">
                <svg className="w-4 h-4 text-gray-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/112733226/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-white/20 transition-all duration-300" aria-label="LinkedIn">
                <svg className="w-4 h-4 text-gray-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-gray-500 mb-5">Company</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-gray-500 mb-5">Services</h4>
            <ul className="space-y-3">
              <li><Link to="/services/web-development" onClick={() => window.scrollTo(0, 0)} className="text-base text-gray-400 hover:text-white transition-colors duration-200">Web Development</Link></li>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-gray-500 mb-5">Get In Touch</h4>
            <p className="text-base text-gray-400 mb-5 leading-relaxed">
              Ready to transform your business with modern solutions?
            </p>
            <a href="mailto:chatterifyservice@gmail.com" className="flex items-center gap-2 text-base text-gray-400 hover:text-white transition-colors duration-200 mb-5">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-[#09090b] text-base font-medium rounded-lg hover:bg-gray-100 transition-all duration-300"
            >
              Contact Us
