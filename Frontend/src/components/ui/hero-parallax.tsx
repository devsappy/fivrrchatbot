...
export const Header = () => {
    return (
        <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 flex flex-col items-center justify-center text-center pt-32">
            <h1 className="text-2xl md:text-7xl font-bold text-white tracking-tight">
                The Ultimate <br /> development studio
            </h1>
            <p className="max-w-2xl text-base md:text-xl mt-8 font-medium leading-relaxed text-gray-400">
