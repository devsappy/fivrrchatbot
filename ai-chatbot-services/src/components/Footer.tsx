        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#services" className="hover:text-white transition-colors">Frontend Development</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to get updates on AI chatbot trends and tips.
            </p>
            <form className="flex">
              <input
                type="email"
              ...
              />
              <button className="bg-gray-600 px-4 py-2 rounded-r-lg hover:bg-gray-700 transition-colors">
                Subscribe
              </button>
            </form>
          </div>
